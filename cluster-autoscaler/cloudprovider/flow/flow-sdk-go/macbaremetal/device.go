...
func NewDeviceService(client flowgo.Client) DeviceService {
	return DeviceService{client: client}
}

func (d DeviceService) List(ctx context.Context, cursor flowgo.Cursor) (list DeviceList, err error) {
...
func getSpecificDevicePath(id int) string {
	return flowgo.Join(devicesSegment, id)
}

func getDeviceVNCPath(id int) string {
	return flowgo.Join(getSpecificDevicePath(id), deviceVNCSegment)
}
