...
func NewClusterService(client flowgo.Client) ClusterService {
...
func (c ClusterService) List(ctx context.Context, cursor flowgo.Cursor) (list ClusterList, err error) {
...
func getSpecificClusterPath(id int) string {
	return flowgo.Join(clusterSegment, id)
}

func getClusterKubeConfigPath(id int) string {
	return flowgo.Join(clusterSegment, id, clusterKubeConfigSegment)
}

func getClusterConfigurationPath(id int) string {
	return flowgo.Join(clusterSegment, id, clusterConfigurationSegment)
}

func getClusterFlavorPath(id int) string {
	return flowgo.Join(clusterSegment, id, clusterFlavorSegment)
}

func getClusterActionPath(id int) string {
	return flowgo.Join(clusterSegment, id, clusterActionSegment)
}
