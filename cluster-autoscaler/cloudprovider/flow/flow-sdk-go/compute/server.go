...
func NewServerService(client flowgo.Client) ServerService {
...
func (s ServerService) List(ctx context.Context, cursor flowgo.Cursor) (list ServerList, err error) {
...
func getSpecificServerPath(serverID int) string {
	return flowgo.Join(serversSegment, serverID)
}

func getServerActionPath(serverID int) string {
	return flowgo.Join(serversSegment, serverID, serverActionSegment)
}

func getServerUpgradePath(serverID int) string {
	return flowgo.Join(serversSegment, serverID, serverUpgradeSegment)
}
