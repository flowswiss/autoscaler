...
func NewSecurityGroupRuleService(client flowgo.Client, securityGroupID int) SecurityGroupRuleService {
	return SecurityGroupRuleService{client: client, securityGroupID: securityGroupID}
}

func (s SecurityGroupRuleService) List(ctx context.Context, cursor flowgo.Cursor) (list SecurityGroupRuleList, err error) {
...
func getSecurityGroupRulesPath(securityGroupID int) string {
	return flowgo.Join(securityGroupsSegment, securityGroupID, securityGroupRulesSegment)
}

func getSpecificSecurityGroupRulePath(securityGroupID, ruleID int) string {
	return flowgo.Join(securityGroupsSegment, securityGroupID, securityGroupRulesSegment, ruleID)
}
