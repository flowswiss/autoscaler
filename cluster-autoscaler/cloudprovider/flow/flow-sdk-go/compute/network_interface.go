...
func NewNetworkInterfaceService(client flowgo.Client, serverID int) NetworkInterfaceService {
...
func getNetworkInterfacesPath(serverID int) string {
	return flowgo.Join(serversSegment, serverID, networkInterfacesSegment)
}

func getSpecificNetworkInterfacePath(serverID, networkInterfaceID int) string {
	return flowgo.Join(serversSegment, serverID, networkInterfacesSegment, networkInterfaceID)
}

func getNetworkInterfaceSecurityPath(serverID, networkInterfaceID int) string {
	return flowgo.Join(serversSegment, serverID, networkInterfacesSegment, networkInterfaceID, networkInterfaceSecuritySegment)
}

func getNetworkInterfaceSecurityGroupsPath(serverID, networkInterfaceID int) string {
	return flowgo.Join(serversSegment, serverID, networkInterfacesSegment, networkInterfaceID, networkInterfaceSecurityGroupsSegment)
}
