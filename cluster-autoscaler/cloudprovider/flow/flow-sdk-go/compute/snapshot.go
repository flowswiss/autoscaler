...
func NewSnapshotService(client flowgo.Client) SnapshotService {
	return SnapshotService{client: client}
}

func (s SnapshotService) List(ctx context.Context, cursor flowgo.Cursor) (list SnapshotList, err error) {
...
func getSpecificSnapshotPath(snapshotID int) string {
	return flowgo.Join(snapshotsSegment, snapshotID)
}
