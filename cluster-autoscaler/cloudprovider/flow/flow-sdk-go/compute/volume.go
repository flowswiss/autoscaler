...
func NewVolumeService(client flowgo.Client) VolumeService {
...
func getSpecificVolumePath(volumeID int) string {
	return flowgo.Join(volumesSegment, volumeID)
}

func getVolumeInstancesPath(volumeID int) string {
	return flowgo.Join(volumesSegment, volumeID, volumeInstancesSegment)
}

func getSpecificVolumeInstancePath(volumeID, instanceID int) string {
	return flowgo.Join(volumesSegment, volumeID, volumeInstancesSegment, instanceID)
}

func getVolumeRevertPath(volumeID int) string {
	return flowgo.Join(volumesSegment, volumeID, volumeRevertSegment)
}

func getVolumeUpgradePath(volumeID int) string {
	return flowgo.Join(volumesSegment, volumeID, volumeUpgradeSegment)
}
