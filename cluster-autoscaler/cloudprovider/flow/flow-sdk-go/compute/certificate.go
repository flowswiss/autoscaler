...
func NewCertificateService(client flowgo.Client) CertificateService {
	return CertificateService{client: client}
}

func (r CertificateService) List(ctx context.Context, cursor flowgo.Cursor) (list CertificateList, err error) {
...
func getSpecificCertificatePath(certificateID int) string {
	return flowgo.Join(certificatesSegment, certificateID)
}
