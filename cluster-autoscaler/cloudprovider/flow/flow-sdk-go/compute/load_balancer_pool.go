...
func NewLoadBalancerPoolService(client flow.Client, loadBalancerID int) LoadBalancerPoolService {
...
func (l LoadBalancerPoolService) List(ctx context.Context, cursor flow.Cursor) (list LoadBalancerPoolList, err error) {
...
func getLoadBalancerPoolsPath(loadBalancerID int) string {
	return flow.Join(loadBalancerSegment, loadBalancerID, loadBalancerPoolsSegment)
}

func getSpecificLoadBalancerPoolPath(loadBalancerID, poolID int) string {
	return flow.Join(loadBalancerSegment, loadBalancerID, loadBalancerPoolsSegment, poolID)
}
