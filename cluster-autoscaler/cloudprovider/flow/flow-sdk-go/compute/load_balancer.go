...
func NewLoadBalancerService(client flow.Client) LoadBalancerService {
...
func (l LoadBalancerService) List(ctx context.Context, cursor flow.Cursor) (list LoadBalancerList, err error) {
...
func getSpecificLoadBalancerPath(loadBalancerID int) string {
	return flow.Join(loadBalancerSegment, loadBalancerID)
}

func getLoadBalancerActionPath(loadBalancerID int) string {
	return flow.Join(loadBalancerSegment, loadBalancerID, loadBalancerActionSegment)
}
